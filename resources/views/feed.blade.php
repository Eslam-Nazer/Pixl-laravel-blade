        ...
        <nav class="mt-10">
            <ul class="flex flex-col gap-3.5">
                ...
                <li class="-ml-4 flex items-center gap-2">
                    ...
                    <a class="hover:underline" href="#">Notification</a>
                </li>
...
<main class="flex grow flex-col gap-4 overflow-y-auto py-4 sm:px-2">
    ...
    >
        <a class="shrink-0" href="/profile.blade">
            <img
                ...
                <div class="border-pixl-light/10 border-b pb-5">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-2.5">
                            <p><a class="hover:underline" href="/profile.blade">Michael</a></p>
                    ...
                    <div class="mt-6 flex items-center justify-between gap-4">
                        <div class="flex items-center gap-8">
                            ...
                            <div class="flex items-center gap-1">
                                <button class="hover:text-pixl" aria-label="Like">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-4.25"
                            ...
                            <!-- Comment -->
                            <div class="flex items-center gap-1">
                                <button class="hover:text-pixl" aria-label="Comment">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-4.25"
                            ...
                            <!-- Re-post -->
                            <div class="flex items-center gap-1">
                                <button class="hover:text-pixl" aria-label="Re-post">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-4.25"
                        ...
                        <div class="flex items-center gap-3">
                            <!-- Save -->
                            <div class="flex items-center gap-1">
                                <button class="hover:text-pixl" aria-label="Save">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-4.25"
                            ...
                            <!-- Share -->
                            <div class="flex items-center gap-1">
                                <button class="hover:text-pixl" aria-label="Share">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-4.25"
                    ...
                    >
                        ...
                        <form class="grow" action="">
                            ...
                            <div class="flex items-center justify-between gap-4">
                                ...
                                <button
                                    class="bg-pixl/10 hover:bg-pixl/20 text-pixl border-transparent px-4 py-1 transition-colors"
                                    type="submit"
                                >
                                    Post
                                </button>
                ...
                <ol>
                    ...
                    <li class="group/li: relative flex items-start gap-4 pt-4">
                        ...
                        <div
                            ...
                            aria-hidden="true"
                        ></div>
                        <a class="isolate shrink-0" href="/profile.blade">
                            <img
                                class="size-10 object-cover"
                                src="/images/simon-chilling.png"
                                alt="Avatar of Simon"
                        ...
                        <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex items-center gap-2.5">
                                    <p>
                                        <a class="hover:underline" href="/profile.blade">Simon</a>
                                    </p>
                      ...
                      ></span>
                            ...
                            <div class="mt-4 flex flex-col gap-3 text-sm">
                                <p>Heh - this is just look like me!</p>
                            </div>
                            <!-- Actions buttons -->
                            <div class="mt-6 flex items-center justify-between gap-4">
                                <div class="flex items-center gap-8">
